    ...
    for seed in range(max_seed+1):
        ...
        if seed_folder in seed_folders:
            ...
            for subset in subsets:
                ...
                activity_path = os.path.join(activity_dir,dataset_dir,seed_folder)
                ...
                if multi_seed:
                    ...
                    df2pkl_path = os.path.join("./results/activity_classification/MN_activity",dataset_dir)
                ...
                if len(count_zero_spikes) == 1:
                    ...
                    if settings["save_hm"]:
                        if multi_seed:
                            path_for_plots = os.path.join("./results/plots/activity_classification/MN_activity",dataset_dir,f"{seed_folder}_{subset}_{settings['n_seed']}repetitions")
                        else:
                            path_for_plots = os.path.join("./results/plots/activity_classification/MN_activity",dataset_dir,f"{seed_folder}_{subset}")
