...
def main(args):
    ...
    R2 = 1
    C = 1
    a = nn.Parameter(torch.Tensor([a]), requires_grad=False)
    print('a',a)
    ...
    batch_size = 128
    my_list = ['2.', '3.']
    custom_lr = {'a': 1.1,'A1':0.1,'A2':0.011,'b':0.005}
    ...
    if args.log:
        writer = SummaryWriter(comment="training_b_custom_lsb1%")  # For logging purpose
    ...
    for e in pbar:
        ...
        with torch.no_grad():
            ...
            accs_hist[1].append(test_acc)  #  safe best test
