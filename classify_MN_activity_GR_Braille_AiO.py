...
for sfx in suffix:
    ...
    seed_folders = [ii for ii in os.listdir(os.path.join(activity_dir,activity_dataset)) if f"{activity_dataset}_{sfx}" in ii]
    ...
    for seed in range(max_seed+1):
        ...
        if seed_folder in seed_folders:
            ...
            for subset in subsets:
                ...
                activity_path = os.path.join(activity_dir,activity_dataset,seed_folder)
                ...
                log_path = os.path.join("./logs/activity_classification/MN_activity",activity_dataset,f"{seed_folder}")
                ...
                LOG.debug("Activity classification from: {} ({})\n".format(activity_dataset+"/"+seed_folder, subset))
                ...
                if multi_seed:
                    ...
                    activity_classification.to_pickle(os.path.join(df2pkl_path,f"{seed_folder}_{subset}_{settings['n_seed']}repetitions_{experiment_datetime}.pkl"))
                    ...
                    df2pkl_path = os.path.join("./results/activity_classification/MN_activity",activity_dataset)
                    create_directory(df2pkl_path)
                    activity_classification.to_pickle(os.path.join(df2pkl_path,f"{seed_folder}_{subset}_{experiment_datetime}.pkl"))
                ...
                if len(count_zero_spikes) == 1:
                    ...
                    if settings["save_hm"]:
                        if multi_seed:
                            path_for_plots = os.path.join("./results/plots/activity_classification/MN_activity",activity_dataset,f"{seed_folder}_{subset}_{settings['n_seed']}repetitions")
                        else:
                            path_for_plots = os.path.join("./results/plots/activity_classification/MN_activity",activity_dataset,f"{seed_folder}_{subset}")
